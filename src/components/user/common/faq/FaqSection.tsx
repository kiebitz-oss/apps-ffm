      ...
      <div className="flex flex-col px-8 md:gap-10 md:px-0 md:ml-6">
        <FaqQuestion
          question={t({
            ...
            message: "Für wen wird die Impfung gegen COVID-19 empfohlen?",
          })}
        >
          <Trans id="user.faq.question.answer.1">
            In der CovPass-App können auch Zertifikate für
            Auffrischungsimpfungen/Booster-Impfungen eingescannt werden. Nach
            der Auffrischungsimpfung haben Sie direkt einen Impfschutz. In
            manchen Fällen wird dies in der App jedoch nicht angezeigt.
          </Trans>
        </FaqQuestion>
        ...
        <FaqQuestion
          question={t({
            ...
            message: "Wie viel Zeit sollte ich für die Impfung einplanen?",
          })}
        >
