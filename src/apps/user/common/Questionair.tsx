...
export const Questionaire: React.FC = () => {
    ...
    return (
        <form
            className="flex flex-col flex-grow mb-6 md:mb-8 lg:max-w-full"
            ...
            {error && !valid && (
                <Error className="mx-8 mt-8 md:mx-0">
                    <Trans id="user.welcome.form_error">
                        Bitte beantworten Sie alle Fragen, denn sonst können wir
                        keine Termine für Sie heraussuchen. Alle Ihre
                        persönlichen Daten werden nur auf Ihrem Endgerät
                        gespeichert und nicht an einen Server übermittelt oder
                        weitergegeben.
                    </Trans>
                </Error>
            )}
